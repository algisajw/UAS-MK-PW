    ...
    <div class="col s12 m8 offset-m2">
        <div class="card white">
            <div class="card-content">
                <span class="card-title grey-text text-darken-4">Tambah Data Penyewaan</span>
                <form action="{{ route('penyewan.store') }}" method="POST">
                    @csrf
                    <div class="input-field">
                        <input type="text" name="nama_penyewa" id="nama_penyewa" required class="validate">
                    ...
                    <div class="input-field" style="margin-top: 35px;">
                        <input type="date" name="tanggal_sewa" id="tanggal_sewa" required class="validate">
                        <label for="tanggal_sewa" class="active">Tanggal Sewa</label>
                    </div>
                    <div class="input-field">
                        <input type="number" name="durasi_hari" id="durasi_hari" required class="validate">
